...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="/zhaohan/ZJH/openpi/physical-intelligence/libero",
            base_config=DataConfig(
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/zhaohan/ZJH/openpi/openpi-assets/checkpoints/pi0_base/params"),
    ...
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="ZJH/openpi/lerobot_libero_data_final",
            base_config=DataConfig(prompt_from_task=True),
        ),
